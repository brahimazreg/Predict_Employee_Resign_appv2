...
st.set_page_config(
    page_title="Employee Resignation Prediction",
    layout="centered"
)
col1 , col2 =st.columns([2,5])
with col1:
    st.image("resign.jpg", width=150)
with col2:
    st.markdown(
        """
        <h1 style='text-align:center; color:#1f77b4;padding-top:0px;'>
...
st.write("Please Fill employee information to predict attrition risk.")
